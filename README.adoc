...
[NOTE]
--
On ubuntu 18.04 (bionic) `pdfmeta` works only with the snap or with version
3.2.x of `pdftk-java`. With every other version of pdftk `CreationDate` and
`ModDate` will not work at all. The other meta data field do work however.
--
